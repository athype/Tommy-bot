const config = {
    ...
    users: {
        ownerId: '418777941879554048', // The bot owner ID, which is you.
        developers: ['418777941879554048', '333455081611722753'] // The bot developers, remember to include your account ID with the other account IDs.
    },
